    ...
    return (
        <div className="login-div">
            <form className="login-form" onSubmit={handleSubmit(onSubmit)}>
                {newUser && <input placeholder="Name" name="name" {...register("name", { required: true, maxLength: 20 })} />}
                <br />
                <input placeholder="Email" name="email" type="email" {...register("email", { required: true, min: 18, max: 99 })} />
                <br />
                {newUser ? <section>
                    <input
                ...
                </section> : <input placeholder="Password" type="password" name="password" {...register("password", { required: true, min: 18, max: 99 })} />}
                <br />
